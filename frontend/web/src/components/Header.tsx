...
const Header = () => {
  return (
    <header className="flex flex-row justify-between items-center w-[96rem] m-auto">
      <a href={NAV.HOME.ROUTE} className="text-3xl font-bold font-inter p-2 select-none">{NAV.LOGO.NAME}</a>
      ...
      >
        ...
        <button className="p-2 h-full">
          <img src={NAV.SEARCH.ICON} className="stroke-primary-white stroke-1" />
        </button>
      </div>
    </header>
  );
